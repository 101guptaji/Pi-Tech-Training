...
using SampleProject7.View;
using SampleProject7.ViewModel.Data;
using System;
...
namespace SampleProject7.ViewModel
{
    public class EmployeeFormViewModel : ObservableObject, ICleanup
    {
        #region Properties
        /// <summary>
